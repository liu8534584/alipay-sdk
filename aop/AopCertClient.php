...
class AopCertClient
{
     ...
     * @param $appAuthToken string 三方应用授权token
     * @return string
     */
     ...
     * @param $privatekey string 商户私钥，根据keyfromfile来判断是读取字符串还是读取文件，false:填写私钥字符串去回车和空格 true:填写私钥文件路径
     * @param $signType string 签名方式，RSA:SHA1     RSA2:SHA256
     * @param $keyfromfile bool 私钥获取方式，读取字符串还是读文件
     * @return string
     */
